...
# Admin site settings
admin.site.site_header = "Plant Disease Prediction Admin"
admin.site.site_title = "Plant Disease Admin Portal"
admin.site.index_title = "Welcome to the Health Plant Disease Prediction Admin Dashboard"
